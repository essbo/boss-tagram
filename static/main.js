        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="comment-form" form-comment-id=${id}>
                    <input type="text" id="input-comment-${id}" class="form-control" placeholder="Kommentar" required/>
                    <button type="submit" class="btn btn-primary mt-2 w-100">Kommentieren</button>
                </form>
            </div>
        </div>
        `
